...
namespace Monhealth.Api.Controllers
{
    ...
    public class ConsultantController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<ResultModel>> GetAllConsultants(int page = 1, int limit = 10, string? expertise = null, string? search = null, bool? status = null, bool? verified = null)
        {
