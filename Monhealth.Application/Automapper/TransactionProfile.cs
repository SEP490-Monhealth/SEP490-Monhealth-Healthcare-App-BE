    ...
    public class TransactionProfile : Profile
    {
        public TransactionProfile()
        {
            CreateMap<Transaction, GetAllTransactionsDTO>()
                 ...
                 .ForPath(dest => dest.Consultant.AvatarUrl, opt => opt.MapFrom(src => src.Booking.Consultant.AppUser.Avatar))
                 ...
                 .ForPath(dest => dest.Member.AvatarUrl, opt => opt.MapFrom(src => src.Booking.User.Avatar))
                 ;
