namespace Monhealth.Application
{
    ...
    {
        public TotalUserDTO TotalUser { get; set; } = new TotalUserDTO();
        public NewUserDTO NewUser { get; set; } = new NewUserDTO();
        public TotalVisitDTO TotalVisit { get; set; } = new TotalVisitDTO();
