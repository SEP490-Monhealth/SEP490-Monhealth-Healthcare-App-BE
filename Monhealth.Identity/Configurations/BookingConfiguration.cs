    ...
    public class BookingConfiguration : IEntityTypeConfiguration<Booking>
    {
        public void Configure(EntityTypeBuilder<Booking> builder)
        {
            ...
            new Booking
            {
                ...
                Notes = "Cần tư vấn về tình trạng hay mệt mỏi gần đây. Mong bác sĩ giúp đỡ!",
            ...
            new Booking
            {
                ...
                Notes = "Đau đầu thường xuyên, cần gặp BS tư vấn. Sắp đi công tác nên cần tư vấn sớm.",
                StartTime = TimeOnly.Parse("09:15:00"),
                EndTime = TimeOnly.Parse("10:15:00"),
                MeetingUrl = "https://meet.google.com/tyn-vafz-asn",
                EvidenceUrls = [],
                CancellationReason = "Bận việc đột xuất, xin hẹn lại sau ạ",
                IsReviewed = false,
            ...
            new Booking
            {
                ...
                Notes = "Khó ngủ mấy tuần nay, muốn hỏi về cách cải thiện giấc ngủ ko cần dùng thuốc",
            ...
            new Booking
            {
                ...
                Notes = "Cần tư vấn về tập gym đúng cách. Mới bắt đầu tập được 1 tháng, hay bị đau cơ.",
            ...
            new Booking
            {
                ...
                Notes = "Muốn hỏi về chế độ ăn kiêng giảm cân. Đã thử nhiều cách nhưng ko hiệu quả lắm.",
            ...
            new Booking
            {
                ...
                Notes = "Hay bị đau lưng khi ngồi làm việc lâu. Cần tư vấn bài tập và ghế ngồi phù hợp.",
            ...
            new Booking
            {
                ...
                Notes = "Muốn hỏi về cách ăn uống lành mạnh cho người tập thể thao. Tôi tập 4 buổi/tuần.",
            ...
            new Booking
            {
                ...
                ConsultantId = Guid.Parse("6bce17d4-909f-4fad-b125-0074793f22bd"),
                Day = DateOnly.Parse("2025-04-11"),
                Notes = "Gần đây hay bị đau dạ dày sau khi ăn cay. Xin BS tư vấn chế độ ăn phù hợp.",
            ...
            new Booking
            {
                ...
                Notes = "Muốn tư vấn về tình trạng căng thẳng kéo dài do công việc, khó thư giãn.",
            ...
            new Booking
            {
                ...
                Notes = "Xin tư vấn bài tập nhẹ nhàng cho người mới phục hồi sau chấn thương đầu gối.",
            ...
            new Booking
            {
                ...
                IsReviewed = true,
                Status = BookingStatus.Completed,
                CompletedAt = DateTime.ParseExact("23-12-2025 11:23:57", "dd-MM-yyyy", null),
                CreatedAt = DateTime.ParseExact("20-12-2025 12:28:57", "dd-MM-yyyy", null),
                UpdatedAt = DateTime.ParseExact("20-12-2025 12:28:57", "dd-MM-yyyy", null),
                CreatedBy = Guid.Parse("9D7E87A9-B070-4607-A0B0-2D2322AECE9B"),
                UpdatedBy = Guid.Parse("9D7E87A9-B070-4607-A0B0-2D2322AECE9B"),
            },
            #endregion
            ...
            new Booking
            {
                ...
                IsReviewed = true,
                Status = BookingStatus.Completed,
                CompletedAt = DateTime.ParseExact("22-01-2025 14:20:20", "dd-MM-yyyy", null),
                CreatedAt = DateTime.ParseExact("19-01-2025 17:50:11", "dd-MM-yyyy", null),
                UpdatedAt = DateTime.ParseExact("19-01-2025 17:50:11", "dd-MM-yyyy", null),
                CreatedBy = Guid.Parse("9D7E87A9-B070-4607-A0B0-2D2322AECE9B"),
                UpdatedBy = Guid.Parse("9D7E87A9-B070-4607-A0B0-2D2322AECE9B"),
            },
            #endregion
            ...
            new Booking
            {
                ...
                IsReviewed = true,
                Status = BookingStatus.Completed,
                CompletedAt = DateTime.ParseExact("18-02-2025 20:21:00", "dd-MM-yyyy", null),
                CreatedAt = DateTime.ParseExact("16-02-2025 09:31:01", "dd-MM-yyyy", null),
                UpdatedAt = DateTime.ParseExact("16-02-2025 09:31:01", "dd-MM-yyyy", null),
                CreatedBy = Guid.Parse("1246B8E5-AF73-4AA3-BDEF-B8815E21A78B"),
                UpdatedBy = Guid.Parse("1246B8E5-AF73-4AA3-BDEF-B8815E21A78B"),
            },
            #endregion
            ...
            new Booking
            {
                ...
                IsReviewed = true,
                Status = BookingStatus.Completed,
                CompletedAt = DateTime.ParseExact("08-03-2025 15:05:10", "dd-MM-yyyy", null),
                CreatedAt = DateTime.ParseExact("05-03-2025 16:22:15", "dd-MM-yyyy", null),
                UpdatedAt = DateTime.ParseExact("05-03-2025 16:22:15", "dd-MM-yyyy", null),
                CreatedBy = Guid.Parse("1246B8E5-AF73-4AA3-BDEF-B8815E21A78B"),
                UpdatedBy = Guid.Parse("1246B8E5-AF73-4AA3-BDEF-B8815E21A78B"),
            },
            #endregion
            ...
            new Booking
            {
                ...
                IsReviewed = true,
                Status = BookingStatus.Completed,
                CompletedAt = DateTime.ParseExact("16-03-2025 14:22:00", "dd-MM-yyyy", null),
                CreatedAt = DateTime.ParseExact("12-03-2025 08:45:20", "dd-MM-yyyy", null),
                UpdatedAt = DateTime.ParseExact("12-03-2025 08:45:20", "dd-MM-yyyy", null),
            ...
            new Booking
            {
                ...
                IsReviewed = true,
                Status = BookingStatus.Completed,
                CompletedAt = DateTime.ParseExact("15-04-2025 12:45:20", "dd-MM-yyyy", null),
                CreatedAt = DateTime.ParseExact("11-04-2025 15:52:27", "dd-MM-yyyy", null),
                UpdatedAt = DateTime.ParseExact("11-04-2025 15:52:27", "dd-MM-yyyy", null),
                CreatedBy = Guid.Parse("3B1A8845-765F-4D91-984A-4E8A9D7D376E"),
                UpdatedBy = Guid.Parse("3B1A8845-765F-4D91-984A-4E8A9D7D376E"),
            }
            #endregion
